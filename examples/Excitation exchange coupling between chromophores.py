# -*- coding: utf-8 -*-
"""
Created on Sun Feb 22 18:32:03 2026
...
# spectra_list_ = []
# for a in range(len(spectra_list)):
#     spectra_list_.append(np.conjugate(spectra_list[a]))
    
    
# spectra_list = spectra_list_
...
pf.plot_contourf_multi_spectra_norm(rephasing_spectra, f1,f2, labels=['E emission', 'E absorption'],
              scale='linear', color_map='jet',title_list=['$R_1$', '$R_2$', '$R_3$', '$R_{rephasing}$'],
              center_scale=False, plot_sum=False, plot_quadrant='All', invert_y=False,
              diagonals=[True, False],nlevels=30,Zoom_coor=[2,3,-3,-2])


pf.plot_contourf_multi_spectra_norm(nonrephasing_spectra, f1,f2, labels=['E emission', 'E absorption'],
              scale='linear', color_map='jet',title_list=['$R_4$', '$R_5$', '$R_6$', '$R_{nonrephasing}$'],
              center_scale=False, plot_sum=False, plot_quadrant='All', invert_y=False,
              diagonals=[False, True],nlevels=30,Zoom_coor=[2,3,2,3])
