...
sys.diagram_donkey([0, 100, 110, 210], [R1], plot_graph=True)
...
#               diagonals=[True, False], plot_graph=True)
...
#               diagonals=[False, True],nlevels=30,Zoom_coor=[1.8,2.3,1.8,2.3])