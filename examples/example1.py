...
sys = System(H=H, rho=rho, a=mu, u=mu, c_ops=c_ops, diagonalize=True)

# generating single trial for R1
sys.diagram_donkey([0, 101, 110, 211], [R1])

# generating 2Dcoherence response for rephasing
time_delays = [100, 9, 100]
scan_id = [0, 2]
response_list = []
...
spectra_list, extent, f1, f2 = sys.spectra((response_list), resolution=1)
